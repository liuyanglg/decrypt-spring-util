...
public class DservJdbcDecrypt {
    ...
    public DservJdbcDecrypt() {
        map = (Map<String, String>) SpringContext.getBean("dservJdbcConfig");
    }
    ...
    public String decrypt() throws Exception {
        ...
        return CryptUtil.decryptFile(sourceFile, outFilePath + validName + FormatDate.getDateStr(format), key);
    }
    ...
    public String encrypt() throws Exception {
        ...
        return CryptUtil.encryptFile(sourceFile, outFilePath + validName + FormatDate.getDateStr(format), key);
    }
