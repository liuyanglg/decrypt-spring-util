...
public class CryptUtil {
     ...
     */
    public static String encryptFile(File sourceFile, String outFile, String sKey) {
...
//            LOG.info("定时任务项目jdbc加密："+enData);
     ...
     */
    public static String decryptFile(File sourceFile, String outFile, String sKey) {
